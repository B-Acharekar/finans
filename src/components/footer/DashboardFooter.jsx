            ...
            <div className="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
                ...
                <div className="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
                    ...
                    <ul className="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                        ...
                        <li><a href="/" className="inline-block px-3 py-2 text-gray-500 hover:text-gray-600">Dashboard</a></li>
                        <li><a href="#features" className="inline-block px-3 py-2 text-gray-500 hover:text-gray-600">Transactions</a></li>
                        <li><a href="#pricing" className="inline-block px-3 py-2 text-gray-500 hover:text-gray-600">Income Tracker</a></li>
                        <li><a href="#about" className="inline-block px-3 py-2 text-gray-500 hover:text-gray-600">Budget</a></li>
                    </ul>
