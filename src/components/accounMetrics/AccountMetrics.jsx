...
const DashboardMetrics = ({ accountNumber }) => {

  return (
    <div className="p-1">
      <AccountDetailsTable accountNumber={accountNumber} />
      <div id="account" className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 lg:grid-cols-3 xl:grid-cols-3">
        {/* Metric Item Start */}
