...
const Footer = () => {
  ...
  return (
    <footer className="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
        ...
        <div className="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2020 Finans. All rights
            reserved.</div>

            <div className="pt-2 pt-4 mt-2 text-center text-gray-600 border-t border-gray-100">Distributed By <a href="https://themewagon.com/">Themewagon</a></div>
    </footer>
  );
};
